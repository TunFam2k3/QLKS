        ...
        <div class="room-details">
            ...
            <div class="room-price" >
				<div class="book-button">
					<a href="xacnhandatphong.php?id_phong=<?php echo $phongId ?>&diadiem=<?php echo $diadiem ?>&price=<?php echo $price ?>&loaiphong=<?php echo $loaiphong ?>"><button>Đặt phòng</button></a>
                </div>
