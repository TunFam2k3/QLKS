...
<body>
	...
	$sobg=15;
		...
		if (empty($inputsearch)) {
				...
				$select = "SELECT * FROM `anhhh` WHERE `price` LIKE '%$inputsearch%' OR `tinhtrang` LIKE '%$inputsearch%' OR `loaiphong` LIKE '%$inputsearch%' OR `diadiem` LIKE '%$inputsearch%' LIMIT $offset, $sobg";
	...
	$tong_bgsearch = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM `anhhh` WHERE `price` LIKE '%$inputsearch%' OR `tinhtrang` LIKE '%$inputsearch%' OR `loaiphong` LIKE '%$inputsearch%' OR `diadiem` LIKE '%$inputsearch%'"));
	...
	<br>
		...
		<div class="menu" >
			<div class="dongmenu" style=" margin: 0 auto; " >
				<a class="menucon" href="addphong.php" >Thêm phòng</a>
				<a class="menucon" href="#" id="showhopthoaixoaadmin"></i>Xóa phòng</a>
	...
	<table  align="center" border="1">
	  <tbody>
		...
		<tr align="center">
		  ...
		  <td style="height: 30px;" width="83">Giá(VND)</td>
		...
		<tr>
		  ...
		  <td>
				<a href="form_suaphong.php?id_phong=<?php echo $id_hang[$i]?>" name="edit"> <i class="fa-solid fa-pen"></i></a>
			</td>
		</tr>
		  <?php  
		  }
	...
	<ul >
        ...
        echo "<li class='chiso'><a class='chiso' href='indexadmin.php?danhmuc=danhsachphong&page=$i&search=$inputsearch'>$i</a></li> ";
				}
			?>
		</ul>
